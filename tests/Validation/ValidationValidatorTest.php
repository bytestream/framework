...
class ValidationValidatorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testValidateSize()
    {
        ...
        $file = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\File')
            ->setMethods(['getSize'])
            ->setConstructorArgs([__FILE__, false])
            ->getMock();
    ...
    public function testValidateMax()
    {
        ...
        $file = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['isValid', 'getSize'])
            ->setConstructorArgs([__FILE__, basename(__FILE__)])
            ->getMock();
    ...
    public function testValidateImage()
    {
        ...
        $v = new Validator($trans, [], ['x' => 'Image']);
        $file2 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
        ...
        $file3 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
        ...
        $file4 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
        ...
        $file5 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
        ...
        $file6 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
    ...
    public function testValidateMime()
    {
        ...
        $file = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension', 'getClientOriginalExtension'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
        ...
        $file2 = $this->getMockBuilder('Symfony\Component\HttpFoundation\File\UploadedFile')
            ->setMethods(['guessExtension', 'isValid'])
            ->setConstructorArgs($uploadedFile)
            ->getMock();
